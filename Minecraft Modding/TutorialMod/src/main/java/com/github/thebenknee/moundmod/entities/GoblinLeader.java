...
public class GoblinLeader extends MonsterEntity
{
	@SuppressWarnings("unchecked")
	public GoblinLeader(EntityType<? extends MonsterEntity> type, World worldIn)
	{
		super((EntityType<? extends MonsterEntity>) MoundEntities.GOBLINLEADER, worldIn);
	}
