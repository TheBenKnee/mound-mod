package com.github.thebenknee.moundmod.world.gen.tree;

import java.util.Random;
import java.util.Set;

import com.github.thebenknee.moundmod.util.BlockUtil;
import com.github.thebenknee.moundmod.util.IBlockPosQuery;
...
public class TreeFeatureBase extends AbstractTreeFeature<NoFeatureConfig>
{
    protected static abstract class BuilderBase<T extends BuilderBase, F extends TreeFeatureBase>
    {
        ...
        public BuilderBase()
        {
            ...
            this.replace = (world, pos) -> world.getBlockState(pos).canBeReplacedByLeaves(world, pos) || world.getBlockState(pos).getBlock().isIn(BlockTags.SAPLINGS) || world.getBlockState(pos).getBlock() == Blocks.VINE || world.getBlockState(pos).getBlock() instanceof BushBlock;
