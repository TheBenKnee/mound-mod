...
public class SpearGoblin extends MonsterEntity
{
	@SuppressWarnings("unchecked")
	public SpearGoblin(EntityType<? extends MonsterEntity> type, World worldIn)
	{
		super((EntityType<? extends MonsterEntity>) MoundEntities.SPEARGOBLIN, worldIn);
	}
